...
if (isset($_REQUEST['id']) && 'delete' == @$_REQUEST['action']) {
  if (!empty($_REQUEST['id'])) {
    ...
    $result = $pages->remove($_REQUEST['id']);
    unset($details);
  }
}
...
?>
  ...
  <div class="my-3 p-3 bg-white rounded box-shadow">
    <h3>Are you sure you want to delete this custom page?</h3><br>
    <form action="remove-page.php?id=<?php echo $details['id']; ?>" method="post" class="form-horizontal">

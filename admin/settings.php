...
if (isset($_REQUEST['save'])) {
  switch ($_REQUEST['save']) {
    ...
    case 'appearance':
      // Colors eliminado. El logo/favicon se suben por AJAX aparte.
    ...
    <form action="settings.php?tab=downloads" method="POST">
      ...
      <div class="adm-card">
        ...
        <div class="adm-toggle" style="margin-bottom:1.25rem;">
          ...
          <label class="adm-switch">
            <input type="checkbox" class="feature-toggle" data-name="dl_limit_enabled" <?php echo ($setting['dl_limit_enabled'] ?? '1') == '1' ? 'checked' : ''; ?>>
            <span class="adm-slider"></span>
          </label>
        </div>

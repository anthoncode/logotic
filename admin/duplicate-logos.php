...
$last        = $start + $maxres - 1;
$allProducts = $product->getAllDuplicateLogos($start, $maxres, $search);
    ...
    <div class="collapse navbar-collapse justify-content-md-center" id="navbarsExample08">
      <ul class="navbar-nav">
        <li class="nav-item active">
          <a class="nav-link" href="<?php echo $setting['website_url']; ?>/admin/duplicate-logos.php">All logos</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="<?php echo $setting['website_url']; ?>/admin/add-product.php">Add Logo</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="<?php echo $setting['website_url']; ?>/admin/best-selling-duplicate-logos.php">Top</a>
        </li>
      </ul>
    </div>
  </nav>
  ...
  <div class="my-3 p-3 bg-white rounded box-shadow">
    <?php if ($num > 0) { ?>
      ...
      <ul class="float-left" style="padding-left: 0;">
        <form action="duplicate-logos.php" method="GET" class="form-inline my-2 my-lg-0">
      ...
      <ul class="pagination float-right">
        <?php
        $back = (($currpage == 1) ? '#' : 'duplicate-logos.php?search='. $search .'&page=' . ($currpage - 1));
        $next = (($currpage == $pages) ? 'duplicate-logos.php?search='. $search .'&page=' . $currpage : 'duplicate-logos.php?search='. $search .'&page=' . ($currpage + 1));
        ?>
        <li class="page-item">
          <a class="page-link">

...
if (isset($_SERVER['HTTP_X_REQUESTED_WITH']) && strtolower($_SERVER['HTTP_X_REQUESTED_WITH']) == 'xmlhttprequest') {
  ...
  if (isset($_FILES['file'])) {
    ...
    $sql_upload = $DB_con->prepare("INSERT INTO " . PFX . "products (submit_user_id, slug_lg, name, cat_id, subc_id, icon_img, created, modified, active) VALUES (:id_admin, :slug, :name2, :cat_id, :scat_id, :icon_img, :created, :modified, '0')");

          ...
          <tbody>
            <?php foreach ($top as $topUser) { ?>
              <tr>
                ...
                <td>
                  <div class="btn-group btn-group-sm" role="group" aria-label="AActions"><a href="add-funds.php?id=<?php echo $topUser['id']; ?>" class="btn btn-outline-primary">Add Credits</a><a href="ban-user.php?id=<?php echo $topUser['id']; ?>" class="btn btn-outline-primary">Ban User</a></div>
                </td>
              </tr>
            <?php } ?>
          </tbody>
...
<?php
  ...
  echo  "<div class='alert alert-danger'>No New Users Recently!</div>";
}

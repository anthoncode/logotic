...
<head>
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    :root {
        --bg: #0d0f1c; --card: #13152a; --border: rgba(255,255,255,.08);
        --accent: #d4ff00; --text: #f0f2ff; --muted: #8b8fa8;
        --danger: #ff4d4d; --success: #2dc653; --radius: 14px;
    }
    body {
    ...
    .login-logo span { display: block; font-size: .75rem; color: var(--muted); margin-top: .35rem; }
    .card {
        background: var(--card);
    ...
    .card-title { font-size: 1.3rem; font-weight: 800; margin-bottom: .25rem; }
    ...
    .alert-error   { background: rgba(255,77,77,.1);   border: 1px solid rgba(255,77,77,.3);   color: var(--danger); }
    .alert-success { background: rgba(45,198,83,.1);   border: 1px solid rgba(45,198,83,.3);   color: var(--success); }
    ...
    .field-input:focus { border-color: var(--accent); background: rgba(212,255,0,.03); }
    ...
    .field-hint { font-size: .7rem; min-height: .9rem; display: block; }
    .field-hint.error { color: var(--danger); }
    .field-hint.ok    { color: var(--success); }
    .grid-2 { display: grid; grid-template-columns: 1fr 1fr; gap: .75rem; }
    /* Strength bar */
    .pwd-strength { height: 3px; border-radius: 99px; background: var(--border); margin-top: .3rem; overflow: hidden; }
    .pwd-strength-bar { height: 100%; border-radius: 99px; transition: width .3s, background .3s; width: 0; }
    .strength-label { font-size: .7rem; color: var(--muted); margin-top: .2rem; }
    /* Password rules */
    .pwd-rules {
    ...
    .pwd-rule { font-size: .72rem; color: var(--muted); display: flex; align-items: center; gap: .4rem; padding: .1rem 0; transition: color .2s; }
    .pwd-rule.pass { color: var(--success); }
    .pwd-rule.pass i::before { content: "\f058"; }
    /* Checkbox */
    .check-row { display: flex; align-items: flex-start; gap: .6rem; margin-top: .25rem; }
    .check-row input { accent-color: var(--accent); margin-top: .15rem; flex-shrink: 0; }
    .check-row label { font-size: .78rem; color: var(--muted); line-height: 1.4; }
    .check-row a { color: var(--accent); }
    /* Button */
    .btn-primary {
        width: 100%; background: var(--accent); color: #0d0f1c;
        border: none; border-radius: 99px; font-size: .9rem;
        font-weight: 800; padding: .75rem; cursor: pointer;
    ...
    .divider { display: flex; align-items: center; gap: .75rem; margin: 1.1rem 0; font-size: .72rem; color: var(--muted); }
    ...
    .btn-google {
        ...
        font-size: .85rem; font-weight: 600; padding: .65rem;
        cursor: pointer; font-family: inherit; transition: all .2s;
        display: flex; align-items: center; justify-content: center;
        gap: .65rem; text-decoration: none;
    }
    .btn-google:hover { background: rgba(255,255,255,.09); border-color: rgba(255,255,255,.2); }
    .btn-google img { width: 18px; height: 18px; }
    .register-footer { text-align: center; margin-top: 1.25rem; font-size: .78rem; color: var(--muted); }
    .register-footer a { color: var(--accent); text-decoration: none; }

    /* Verify email screen */
    .verify-screen { text-align: center; padding: 1rem 0; }
    .verify-icon { font-size: 3.5rem; color: var(--accent); margin-bottom: 1rem; display: block; }
    .verify-title { font-size: 1.2rem; font-weight: 800; margin-bottom: .5rem; }
    .verify-sub { color: var(--muted); font-size: .85rem; line-height: 1.6; margin-bottom: 1.25rem; }
    .verify-email-badge {
...
document.getElementById('togglePwd')?.addEventListener('click', function() { togglePass('pwd','togglePwd'); });
document.getElementById('togglePwd2')?.addEventListener('click', function() { togglePass('pwd2','togglePwd2'); });
